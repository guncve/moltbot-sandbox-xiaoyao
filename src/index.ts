...
function validateRequiredEnv(env: MoltbotEnv): string[] {
  ...
  // Check for AI provider configuration (OpenRouter, AI Gateway, or direct Anthropic)
  if (env.OPENROUTER_API_KEY) {
    // OpenRouter configuration - uses OpenAI API protocol
    ...
    missing.push('ANTHROPIC_API_KEY, AI_GATEWAY_API_KEY, or OPENROUTER_API_KEY');
  }
